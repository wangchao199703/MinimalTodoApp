...
const EXTRA: Record<Lang, Record<string, string>> = {
  "zh-CN": {
    ...
    "S.X.Prio.Apple": "苹果(圆环+!)",
    "S.X.Prio.Linear": "极客(左侧竖线)",
    "S.X.Prio.Signal": "信号强度",
    "S.X.Prio.Notion": "文档(标题着色)",
    "S.X.Prio.None": "不展示",
    "S.X.Outdent": "提升一级",
  ...
  en: {
    ...
    "S.X.Prio.Apple": "Apple (ring + !)",
    "S.X.Prio.Linear": "Geek (left bar)",
    "S.X.Prio.Signal": "Signal bars",
    "S.X.Prio.Notion": "Docs (title color)",
