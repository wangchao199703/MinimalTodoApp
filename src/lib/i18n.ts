...
const EXTRA: Record<Lang, Record<string, string>> = {
  "zh-CN": {
    ...
    "S.X.Design.DarkGlass": "深邃暗玻",
    "S.X.Design.DarkGlassDesc": "深色玻璃压底 · 纯白字(配深色主题)",
  ...
  en: {
    ...
    "S.X.Design.DarkGlass": "Dark glass",
    "S.X.Design.DarkGlassDesc": "Dark glass, pure white text (dark themes)",
